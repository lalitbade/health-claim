  ...
  return (
    ...
    >
      <motion.div
        initial={{ scale: 0.9 }}
        animate={{ scale: 1 }}
        className="bg-white dark:bg-gray-900 p-6 rounded-xl shadow-2xl text-gray-900 dark:text-white w-full max-w-md"
      >
        {/* Header */}
        ...
        <div className="text-center mb-4">
          ...
          <h3 className={`mt-2 text-lg font-semibold ${decision === "Approve" ? "text-green-500" : "text-red-500"}`}>
        ...
        <div className="space-y-3 text-sm">
          <div className="p-3 border rounded-lg bg-gray-100 dark:bg-gray-800">
            ...
            <pre className="text-gray-800 dark:text-white whitespace-pre-wrap break-words">{extracted_text}</pre>
          </div>

          <div className="grid grid-cols-2 gap-3">
            <div className="p-3 border rounded-lg bg-gray-100 dark:bg-gray-800 text-center">
            ...
            <div className="p-3 border rounded-lg bg-gray-100 dark:bg-gray-800 text-center col-span-2">
